...
export namespace UtilsPoFile {
  ...
  export function mergeGettextFile(
    jsonContent1FromTsHtml: UtilsI18n.GettextFile,
    json2ContentFromPoFileModifedByUser?: UtilsI18n.GettextFile | null,
  ): UtilsI18n.GettextFile {
    //#region @backendFunc
    const oldTagsByKey = new Map<string, UtilsI18n.GettextExtracted>();
  ...
  function getGettextTagKey(
    tag: Pick<UtilsI18n.GettextExtracted, 'gettextString' | 'context'>,
  ): string {
